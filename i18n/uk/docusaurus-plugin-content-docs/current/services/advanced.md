...
2. Збирає Docker-образ за допомогою Dockerfile сервісу на Marquee
...
При створенні Playground кожен динамічний сервіс може використовувати іншу гілку з свого [Prop](/core-concepts/prop):

- **За замовчуванням** — Використовує гілку Prop за замовчуванням (зазвичай `main`)
