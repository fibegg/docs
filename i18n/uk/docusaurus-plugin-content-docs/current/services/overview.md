...
**Динамічний сервіс** підтримується вихідним кодом з [Prop](/core-concepts/prop). Він підтримує два режими роботи:
...
4. **Перевіряє** що динамічні сервіси мають привʼязаний Prop, шлях до Dockerfile та робочу директорію
