...
Коли ви створюєте Playroom, ви надаєте SSH-дані для підключення до віддаленого сервера з встановленим Docker. fibe.gg підключається до цього сервера по SSH і використовує Docker Compose для оркестрації ваших сервісів. [Traefik](https://traefik.io/) працює на кожному Playroom як реверс-проксі, забезпечуючи маршрутизацію, HTTPS-сертифікати та автентифікацію.
