...
Платформа перевіряє, що всі посилання `$$var__NAME` у тілі шаблону оголошені в секції `fibe.gg > variables`, і навпаки. Неоголошені або невикористані змінні спричинять помилку валідації.
:::
